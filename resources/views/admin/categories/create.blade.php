...
@section('content')
		<div class="container-fluid p-5 ">
			...
			<form action="{{ route('categories.store') }}" method="post" class="card p-4 m-2 p-4 mb-5" style='background-color: rgb(253, 253, 253); border:none; border-radius: 1% ' enctype="multipart/form-data">
			  @csrf
			  <div class="form-row">
			    ...
			    <div class="form-group col-md-2">
			      <label for="exampleFormControlInput1">&nbsp;</label>
			      <a href="{{ route('categories.index') }}" class=" form-control btn btn-light font-weight-bold">Cancel</a>
			    </div>
			  </div>
			</form>
		</div>
