          ...
          <div class="container-fluid" style="padding: 4%; width: 100%; background-color:(252, 252, 252)">
            ...
            <form action="/jobs/?=">
              <div class="card-body">
                <div class="form-row">
                  <div class="pb-3">
                    <h2 class="font-weight-bold">Find your job</h2>
                    <small>Job portal helps people to get jobs and hire employee</small>
                  </div>
                </div>
                  ...
                  <div class="row m-2 pl-5">
                      @foreach(\App\Region::get(['id', 'name']) as $region)
                        <div class="col-lg-3 card p-2 m-2 bg-white rounded  text-center" style="border: solid 1px rgb(240, 240, 240)">
                          <small>
                           <a href="{{route('jobs.index', ['region_id' => $region->id])}}">
                            <b>{{$region->name}}</b><br>
                            <label class="badge badge-primary badge-pill p-2 mt-2">Live Jobs: {{$region->jobs()->count()}}</label>
                          </a>
                         </small>
                        </div>
                      @endforeach
