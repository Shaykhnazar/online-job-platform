...
@section('content')
    @include('layouts.parts.breadcrumbs', ['title' => 'Education degree edit'])
    ...
    <div class="container-fluid p-5 " >
			...
			<form action="{{ route("education.update", $education->id) }}" method="post" class="card p-4 m-2 p-4 mb-5" style='background-color: rgb(253, 253, 253); border:none; border-radius: 1% '>
			  @csrf
			  <div class="form-row">
